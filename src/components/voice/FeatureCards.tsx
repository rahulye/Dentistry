    ...
    <div className="grid md:grid-cols-2 gap-8 mb-12">
      ...
      <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30">
        ...
        <CardHeader className="relative">
          ...
          <CardDescription className='p-2'>Simple steps to get started with voice assistance</CardDescription>
        </CardHeader>
      ...
      <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30">
        ...
        <CardHeader className="relative">
          ...
          <CardDescription className='p-2'>Advanced capabilities for dental care</CardDescription>
        </CardHeader>
        <CardContent className="relative space-y-4">
