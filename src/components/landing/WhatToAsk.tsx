...
function WhatToAsk() {
	return (
		<section className="relative py-32 px-6 overflow-hidden bg-linear-to-b from-background to-muted/10" id="FAQ">
			<div className="relative z-10 max-w-7xl mx-auto">
				...
				<div className="flex justify-center">
					...
					<div className="max-w-5xl">
						<h3 className="text-xl bg-linear-to-br from-white/70 to-white/70 text-transparent bg-clip-text lg:text-2xl font-bold mb-8">
							Common questions our AI can answers:
						</h3>
						<div className="space-y-6 flex max-w-3xl flex-col justify-center ">
							{/* 1 */}
