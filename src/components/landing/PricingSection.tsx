...
const PricingSection = () => {
	return (
		<section
			className="relative py-32 px-6 overflow-hidden bg-linear-to-br from-background/10 to-muted/10"
			id="pricing"
		>
			{/* grid */}
			<div className="absolute inset-0">
				<div className="absolute inset-0 bg-linear-to-br from-background/10 via-muted/10 to-muted/10">
					<div className="absolute inset-0 bg-[linear-gradient(to_right,#e2e8f0_1px,transparent_1px),linear-gradient(to_bottom,#e2e8f0_1px,transparent_1px)] bg-size-[2rem_2rem] mask-[radial-gradient(ellipse_75%_50%_at_50%_50%,#000_50%,transparent_85%)] opacity-10"></div>
				</div>
						...
						<div className="relative bg-linear-to-br from-card/95 to-card/70 backdrop-blur-xl rounded-3xl p-8 border-2 border-primary/30 hover:border-primary/50 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-primary/20 scale-105">
							<div className="space-y-6">
								...
								<div className="space-y-4">
									...
									<div className="flex items-start gap-3">
										<CheckCircleIcon className="w-5 h-5 text-primary mt-0.5 shrink-0" />
										<span className="text-sm">Call transcripts</span>
									</div>
								</div>
							</div>
						</div>
